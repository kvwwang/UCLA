...
MNB = MultinomialNB()
X_MNB = MNB.fit(X_tfidf,eight_train.target)
...
fpr,tpr,thresh = roc_curve(eight_test.target,MNB_pred)
roc_auc = auc(fpr,tpr)
...
print(classification_report(eight_test.target,MNB_pred,target_names=eight_test.target_names))
print(accuracy_score(eight_test.target,MNB_pred))

confusion_matrix(eight_test.target,MNB_pred)
